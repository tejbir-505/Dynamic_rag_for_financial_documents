...
def process_pdf(pdf_path: str) -> Dict[str, Any]:
    ...
    try:
        with pdfplumber.open(pdf_path) as pdf:
            ...
            for page_number, page in enumerate(pdf.pages, start=1):
                ...
                # Extract and sort tables on this page
                ...
                # Handle table continuation logic
            ...
            # Finalize any remaining ongoing table
    ...
    # Build combined text and pages map
